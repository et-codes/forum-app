...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230124015551_AddCategoryModifiedDate")]
    partial class AddCategoryModifiedDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Entities.PostEntity", b =>
                {
                    ...
                    b.HasOne("Core.Entities.PostEntity", "InReplyTo")
                        .WithMany()
                        .HasForeignKey("InReplyToId");

                    b.HasOne("Core.Entities.CategoryEntity", "PostCategory")
                        .WithMany()
